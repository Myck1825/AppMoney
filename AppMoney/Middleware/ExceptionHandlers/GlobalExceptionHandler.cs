...
namespace AppMoney.ExceptionHandlers.Middleware
{
    ...
    : IExceptionHandler
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            logger.LogError(exception, UnhandledExceptionMsg + " " + exception.Message);

            var problemDetails = CreateProblemDetails(context, exception);
            var response = new ServerResponse<ProblemDetails>()
            {
        ...
        private string ToJson(in ServerResponse<ProblemDetails> response)
        {
            try
            {
